...
//      rect.bottom = rect.bottom * cameraResolution.y / screenResolution.y;
    ...
    private int getRotationCount() {
        int displayOrientation = camera.getOrientation();
        return displayOrientation / 90;
    }

    public Rect getRotatedRect(Rect rect) {
        if (rotatedRect == null) {
            int previewWidth = configManager.getBestPreviewSize().x;
            int previewHeight = configManager.getBestPreviewSize().y;
